...
extern int32_t g_redSplitDukeMatchMode;
extern int32_t g_redSplitDukeMatchHumanPlayers;
extern int32_t g_redSplitDukeMatchBots;
extern int32_t g_redSplitDukeMatchType;
...
extern int32_t g_redSplitWeaponPerWeaponWideOffsetX[MAX_WEAPONS];
extern int32_t g_redSplitWeaponWideTopOffsetY;
extern int32_t g_redSplitWeaponWideScalePercent;
extern int32_t g_redSplitWeaponPerWeaponWideScalePercent[MAX_WEAPONS];
...
extern int32_t g_redSplitWeaponWheelQuarterScalePercent;
...
extern int32_t g_redSplitWeaponAlienGlowOffsetY;
extern int32_t g_redSplitWeaponAlienGlowSpreadPercent;
extern int32_t g_redSplitWeaponAlienGlowSmall1OffsetX;
extern int32_t g_redSplitWeaponAlienGlowSmall1OffsetY;
extern int32_t g_redSplitWeaponAlienGlowSmall2OffsetX;
extern int32_t g_redSplitWeaponAlienGlowSmall2OffsetY;
extern int32_t g_redSplitWeaponMissileRightOffsetX;
extern int32_t g_redSplitWeaponMissileRightOffsetY;
extern int32_t g_redSplitWeaponMissileQuarterRightOffsetX;
extern int32_t g_redSplitWeaponMissileQuarterRightOffsetY;
extern int32_t g_redSplitWeaponMissileRocketOffsetX;
extern int32_t g_redSplitWeaponMissileRocketOffsetY;
extern int32_t g_redSplitWeaponMissileQuarterRocketOffsetX;
extern int32_t g_redSplitWeaponMissileQuarterRocketOffsetY;
extern int32_t g_redSplitWeaponMissileFlashOffsetX;
extern int32_t g_redSplitWeaponMissileFlashOffsetY;
extern int32_t g_redSplitWeaponMissileQuarterFlashOffsetX;
extern int32_t g_redSplitWeaponMissileQuarterFlashOffsetY;
extern int32_t g_redSplitWeaponTripLeftOffsetX;
extern int32_t g_redSplitWeaponTripLeftOffsetY;
extern int32_t g_redSplitWeaponTripRightOffsetX;
extern int32_t g_redSplitWeaponTripRightOffsetY;
extern int32_t g_redSplitWeaponTripMineScalePercent;
extern int32_t g_redSplitWeaponTripQuarterLeftOffsetX;
extern int32_t g_redSplitWeaponTripQuarterLeftOffsetY;
extern int32_t g_redSplitWeaponTripQuarterRightOffsetX;
extern int32_t g_redSplitWeaponTripQuarterRightOffsetY;
extern int32_t g_redSplitWeaponTripQuarterMineScalePercent;
extern int32_t g_redSplitWeaponKickArmedOffsetX;
...
void RedSplit_OpenPauseMenuFromExtra(int32_t playerNum);
void RedSplit_ActivateExtraMenuSelection(int32_t playerNum);
void RedSplit_MoveExtraMenuSelection(int32_t playerNum, int32_t direction);
void RedSplit_ChangeExtraMenuOption(int32_t playerNum, int32_t direction);
void RedSplit_BackExtraMenu(int32_t playerNum);
